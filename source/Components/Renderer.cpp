...
Renderer::Renderer(int _initialWidth, int _initialHeight) {
    main_camera = std::make_unique<Camera>(glm::vec3(0.0f, 55.0f, 30.0f), glm::vec3(0.0f), _initialWidth, _initialHeight);

    default_shader = Shader::Library::CreateShader("shaders/default.vert", "shaders/default.frag");

    auto main_light_position = glm::vec3(10.0f, 13.0f, 0.0f);
    ...
    racket_one_position = glm::vec3(-15.0f, 0.0f, -15.0f);
    racket_one_rotation = glm::vec3(0.0f);
    racket_one_scale = glm::vec3(1.0f);

    racket_two_position = glm::vec3(-15.0f, 0.0f, 15.0f);
    racket_two_rotation = glm::vec3(0.0f);
    racket_two_scale = glm::vec3(1.0f);

    racket_three_position = glm::vec3(15.0f, 0.0f, -15.0f);
    racket_three_rotation = glm::vec3(0.0f, 180.0f, 0.0f);
    racket_three_scale = glm::vec3(1.0f);

    racket_four_position = glm::vec3(15.0f, 0.0f, 15.0f);
    racket_four_rotation = glm::vec3(0.0f, 180.0f, 0.0f);
    racket_four_scale = glm::vec3(1.0f);
    ...
    racket_cubes[0] = VisualCube(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(1.0f), transform_offset, skin_s_descriptor); //skin
    ...
    racket_cubes[1] = VisualCube(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(1.0f), transform_offset, black_s_descriptor); //racket handle (black plastic)
    ...
    racket_cubes[2] = VisualCube(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(1.0f), transform_offset, blue_s_descriptor); //racket piece (blue plastic)
    ...
    racket_cubes[3] = VisualCube(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(1.0f), transform_offset, green_s_descriptor); //racket piece (green plastic)
    ...
    racket_cubes[4] = VisualCube(glm::vec3(0.0f), glm::vec3(0.0f), glm::vec3(1.0f), transform_offset, white_s_descriptor); //racket net (white plastic)
}
...
void Renderer::Render(GLFWwindow* _window, const double _deltaTime) {
    ...
    //draws rackets
    DrawOneRacket(racket_one_position, racket_one_rotation, racket_one_scale);
    DrawOneRacket(racket_two_position, racket_two_rotation, racket_two_scale);
    DrawOneRacket(racket_three_position, racket_three_rotation, racket_three_scale);
    DrawOneRacket(racket_four_position, racket_four_rotation, racket_four_scale);
}
...
void Renderer::InputCallback(GLFWwindow* _window, const double _deltaTime) {
    ...
    switch (selected_player) {
        case 0:
            racket_position = &racket_one_position;
            racket_rotation = &racket_one_rotation;
            racket_scale = &racket_one_scale;
            break;
        case 1:
            racket_position = &racket_two_position;
            racket_rotation = &racket_two_rotation;
            racket_scale = &racket_two_scale;
            break;
        case 2:
            racket_position = &racket_three_position;
            racket_rotation = &racket_three_rotation;
            racket_scale = &racket_three_scale;
            break;
        case 3:
            racket_position = &racket_four_position;
            racket_rotation = &racket_four_rotation;
            racket_scale = &racket_four_scale;
            break;
    }
    //keyboard triggers
    //render mode
